<template>
  <div class="help-page xj-scene-study">
    <div class="container help-container narrow">
      <h1 class="help-title">发起求助</h1>
      <p class="help-sub">填写清楚问题背景，系统会自动匹配同专业校友与学长学姐来解答</p>
      ...
      <div class="xj-card form-card">
        ...
        <div class="xj-field">
          <label class="xj-label">问题类型</label>
...
.help-title { margin: 0; font-size: 23px; font-weight: 850; color: var(--xj-ink); }
.help-sub { margin: 8px 0 20px; font-size: 13.5px; color: var(--xj-muted); }
